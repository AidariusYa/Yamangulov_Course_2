...
## Описание
Основная функция всей программы по взаимодействию с банковскими транзакциями.
### Примеры использования функций:

Поиск интересующих транзакций с применением фильтров.

Search_transactions

## Описание

В модуле две функции. Функция, которая принимает список словарей с информацией о банковских операциях и строку для поиска,
и возвращает список словарей, содержащих эту строку в описании. А также функция, которая создает и возвращает словарь, где ключами являются названия категорий, а значениями —
количество операций в каждой из этих категорий.
### Примеры использования функций:

Функции используются в модуле main.py для сортировки транзакций по желанию пользователя.
